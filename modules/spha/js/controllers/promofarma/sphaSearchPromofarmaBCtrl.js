...
(function () { 
 'use strict';
	...
	.controller('sphaSearchPromofarmaBCtrl',
		...
		function ( PropertiesServiceSpha, cityServicesSpha, sphaCompanyServices, sphaPossibleValueServices,shareDataServices, $rootScope,
                   $stateParams, $state, $scope, $window, $cookies, $q, $translate, httpServices,
                   NgTableParams, $uibModal, $filter, SweetAlert, sphaPromofarmaServices, sphaProcedureInstanceServices ) {
				var vm = this;
				
				var procedureInstanceDTO = shareDataServices.get('SELECTED_PROCEDURE_INSTANCE_DTO');
			    const tableType = 'FLUSSO_PROMOFARMA_B';
				...
				var searchUrl = apiAnagraphicUrl + "api/promofarmaB/list";
				var exportUrl = apiAnagraphicUrl + "api/promofarmaB/export";
				var getMassiveActionByUserUrl = apiAnagraphicUrl + "api/promofarmaB/actions";
				var dataType = "FLOW_PROMOFARMA_B";
