...
(function () { 
 'use strict';
	...
	.factory( 'sphaFsnServices', ['$log', '$http', 'httpServices' ,'PropertiesServiceSpha', '$q',
        function ( $log, $http, httpServices, PropertiesServiceSpha, $q ) {
			...
			var getMassiveActionByUserUrl = anagraphicMsBaseUrl + "api/fsn/actions";
			...
			services.getDataVisibilityRule = function (callback) {
                const body = {dataType: {equals: "FLOW_FSN"}};
