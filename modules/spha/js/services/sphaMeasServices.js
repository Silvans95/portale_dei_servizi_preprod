...
(function () { 
 'use strict';
	...
	.factory( 'sphaMeasServices', ['$log', '$http', 'httpServices' ,'PropertiesServiceSpha', '$q',
        function ( $log, $http, httpServices, PropertiesServiceSpha, $q ) {
			...
			var getMassiveActionByUserUrl = anagraphicMsBaseUrl + "api/meas/actions";
			...
			services.getDataVisibilityRule = function (callback) {
                const body = {dataType: {equals: "FLOW_MEAS"}};
