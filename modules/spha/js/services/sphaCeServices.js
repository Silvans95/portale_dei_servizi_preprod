...
(function () { 
 'use strict';
	...
	.factory( 'sphaCeServices', ['$log', '$http', 'httpServices' ,'PropertiesServiceSpha', '$q',
        function ( $log, $http, httpServices, PropertiesServiceSpha, $q ) {
			...
			var getMassiveActionByUserUrl = anagraphicMsBaseUrl + "api/ce/actions";
			...
			services.getDataVisibilityRule = function (callback) {
                const body = {dataType: {equals: "FLOW_CE"}};
